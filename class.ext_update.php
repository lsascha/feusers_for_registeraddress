...
class ext_update
{
    ...
    public function __construct()
    {
        ...
        if (VersionNumberUtility::convertVersionNumberToInteger($typo3Version) >= 8000000) {
            ...
            $this->queryBuilder = GeneralUtility::makeInstance(\TYPO3\CMS\Core\Database\ConnectionPool::class)->getQueryBuilderForTable('fe_users');
        } else {
    ...
    public function main() {
        ...
        if (VersionNumberUtility::convertVersionNumberToInteger($typo3Version) >= 8000000) {
            ...
            foreach ($addresslist as $fixAddress) {
                $content .= 'Updating fe_users uid:' . $fixAddress['uid'] . PHP_EOL;
        ...
        $content .= 'fe_users entries updates finished.' . PHP_EOL;
